...
public class EffectsActivity extends Activity implements ActionBar.TabListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		tab.setText(R.string.tab_pentagons);
		tab.setTag(new ViewPentagons(this));
		actionBar.addTab(tab);

		tab = actionBar.newTab();
		tab.setTabListener(this);
		tab.setText(R.string.tab_circles);
		...
		tab.setTag(new ViewRubber(this));
		actionBar.addTab(tab);
		...
		tab = actionBar.newTab();
		tab.setTabListener(this);
		tab.setText(R.string.tab_stars);
		tab.setTag(new ViewStars(this));
		actionBar.addTab(tab);
